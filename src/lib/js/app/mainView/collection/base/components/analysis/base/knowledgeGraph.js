  ...
  async createNode(data, idx) {
    ...
    if (params.label === Vertices.Asset) {
      ...
      if (data.faceId && data.collectionId) {
        const key = `face-collection/${data.collectionId}/${data.faceId}.png`;
        params.image = await this.faceManager.getFaceImage(key);
      }

      // TODO: REMOVED THIS! TESTING ONLY!
      /*
      params.image = await this.faceManager.getFaceImage(
        'face-collection/Marvel/b9704e77-c69a-4714-9019-10ab73d64252.png'
      );
      */
    }
