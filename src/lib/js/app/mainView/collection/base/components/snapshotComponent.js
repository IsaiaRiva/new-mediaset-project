...
const CONFIRMED = Localization.Alerts.Confirmed;
const MSG_NAME = Localization.Messages.Name;
const MSG_SELECT_COLLECTION = Localization.Messages.SelectFaceCollection;
const MSG_CONFIRMATION = Localization.Alerts.ConfirmFaceIndexed;
const MSG_ENABLE_SNAPSHOT_MODE = Localization.Messages.EnableSnapshotMode;
const ERR_INVALID_COLLECTION = Localization.Alerts.InvalidFaceCollectionSelection;
const ERR_INVALID_FACE_NAME = Localization.Alerts.InvalidIndexedName;
const BTN_INDEX_FACE = Localization.Buttons.IndexFace;
const TOOLTIP_INDEX_FACE = Localization.Tooltips.IndexFace;
