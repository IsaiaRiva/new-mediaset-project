...
const MSG_TITLE = Localization.Messages.Title;
const MSG_PASSWORD_REQ = Localization.Messages.PwdRequirement;
const MSG_RESET_SEND_CODE = Localization.Messages.ResetSendCode;
const MSG_RESET_PASSWORD = Localization.Messages.ResetPwd;
const MSG_MISMATCH_PASSWORDS = Localization.Alerts.MismatchPwds;
const MSG_PASSWORD_NOT_CONFORM = Localization.Alerts.PwdConformance;
const MSG_SIGNIN_PROBLEM = Localization.Alerts.SignInProblem;
const MSG_USERNAME_NOT_CONFORM = Localization.Alerts.UsernameConformance;
